...
namespace PeanutAdmin\App\modules\peanut\reference_codes;
    ...
    ResourceCreatePolicyProvider
{
    ...
    public function tenantConstraint(
        ...
        return new TenantEquals(new ColumnReference('entry.tenant_id'), $context->tenant->tenantId);
    }
    ...
    public function requestedTargetConstraint(
        ...
        return $targets->sets === [] ? new AlwaysTrue() : new \PeanutAdmin\DataPermission\Constraint\AlwaysFalse();
    }
