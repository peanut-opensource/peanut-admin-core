...
namespace ExampleHost\App\Modules\Peanut\TaskJob;
...
{
    public function moduleKey(): string { return 'peanut.task-job'; }
    ...
    public function tenantConstraint(AuthorizationContext $context, ResourceOperation $operation): QueryConstraint { return new TenantEquals(new ColumnReference('task.tenant_id'), $context->tenant->tenantId); }
