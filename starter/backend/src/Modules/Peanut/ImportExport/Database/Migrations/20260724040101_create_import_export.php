...
{
    public static function moduleKey(): string { return 'peanut.import-export'; }
    public static function ownedTables(): array { return Schema::tableNames(); }
    public static function reversible(): bool { return true; }
    public function up(): void { foreach (Schema::tableNames() as $table) $this->execute(Schema::createSql($table)); }
    public function down(): void { foreach (array_reverse(Schema::tableNames()) as $table) $this->execute(Schema::dropSql($table)); }
}
