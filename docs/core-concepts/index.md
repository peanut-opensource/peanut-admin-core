...
A Module provider declares its contract-to-implementation bindings without
receiving a framework container. Core validates and combines those declarations;
the Host's single composition root is the only code that applies them.
