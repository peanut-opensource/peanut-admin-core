...
- **Understand the PHP Runtime direction:** read the [accepted ThinkPHP 8 convergence projection](./architecture/index.md#accepted-thinkphp-8-runtime-direction); current PDO APIs are migration input, not a framework-neutral support promise.
...
- **Publish a source tag:** follow [Release qualification binding](./guide/release-qualification.md) for fixed-candidate evidence and package digests.
