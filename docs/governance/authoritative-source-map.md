...
| Runtime, toolchain and publication resources and CI stage triggers | `resources/project-resources.json` plus the consuming workflow event, immutable candidate input and job environment | testing guide |
